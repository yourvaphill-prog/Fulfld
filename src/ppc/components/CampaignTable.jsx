  ...
  return (
    <div style={s.container}>
      <div style={s.toolbar}>
        ...
        />
        <span style={{ color: '#555', fontSize: 12 }}>{rows.length} campaigns</span>
      </div>
              ...
              <tr key={i} style={{ background: i % 2 === 0 ? 'transparent' : '#090909' }}>
                ...
                <td style={s.td}>
                  {row.avgAcos === 'NO_SALES'
                    ? <span style={{ color: '#ef4444', fontSize: 11, fontWeight: 600 }}>No Sales</span>
                ...
                <td style={s.td}>
                  <span style={{ color: (row.avgRoas ?? 0) >= thresholds.goodROASThreshold ? '#22c55e' : '#ccc' }}>
                    {fmtRoas(row.avgRoas)}
                  </span>
                </td>
